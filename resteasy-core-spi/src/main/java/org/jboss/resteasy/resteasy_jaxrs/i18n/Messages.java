...
public interface Messages
{
   ...
   @Message(id = BASE
         + 25, value = "Bad Base64 input character decimal {0} in array position {1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 35, value = "Base64-encoded string must have at least four characters, but length specified was %s")
   ...
   @Message(id = BASE
         + 85, value = "Cannot have offset of {0} and length of {1} with array of length {2}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 115, value = "You can only set one of LinkHeaderParam.rel() and LinkHeaderParam.title() for on {0}.{1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 130, value = "Class is not a root resource.  It, or one of its interfaces must be annotated with @Path: %s implements: ")
   ...
   @Message(id = BASE
         + 145, value = "Unable to find a MessageBodyReader of content-type {0} and type {1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 170, value = "Could not create a default entity type factory of type {0}", format = Format.MESSAGE_FORMAT)
   String couldNotCreateEntityFactory(String className);

   @Message(id = BASE
         + 175, value = "Could not create a default entity type factory of type {0}. {1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 200, value = "Could not find message body reader for type: {0} of content type: {1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 215, value = "could not find writer for content-type {0} type: {1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 265, value = "Destination array with length {0} cannot have offset of {1} and still store three bytes.", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 315, value = "You have exceeded your maximum forwards ResteasyProviderFactory allows.  Last good uri: %s")
   ...
   @Message(id = BASE
         + 425, value = "Incorrect type parameter. ClientExceptionMapper requires a subclass of java.lang.Throwable as its type parameter.")
   String incorrectTypeParameterClientExceptionMapper();

   @Message(id = BASE
         + 430, value = "Incorrect type parameter. ExceptionMapper requires a subclass of java.lang.Throwable as its type parameter.")
   ...
   @Message(id = BASE
         + 445, value = "Interceptor class must be annotated with @ServerInterceptor and/or @ClientInterceptor")
   String interceptorClassMustBeAnnotated();

   @Message(id = BASE
         + 450, value = "Interceptor class %s must be annotated with @ServerInterceptor and/or @ClientInterceptor")
   ...
   @Message(id = BASE
         + 485, value = "JNDI Component Resource variable is not set correctly: jndi;class;true|false comma delimited")
   String jndiComponentResourceNotSetCorrectly();

   @Message(id = BASE
         + 490, value = "The %s config in web.xml could not be parsed, accepted values are true,false or 1,0")
   ...
   @Message(id = BASE
         + 575, value = "You must define a @Consumes type on your client method or interface, or supply a default")
   String mustDefineConsumes();

   @Message(id = BASE
         + 580, value = "You must set either LinkHeaderParam.rel() or LinkHeaderParam.title() for on {0}.{1}", format = Format.MESSAGE_FORMAT)
   ...
   @Message(id = BASE
         + 800, value = "Source array with length {0} cannot have offset of {1} and still process four bytes.", format = Format.MESSAGE_FORMAT)
